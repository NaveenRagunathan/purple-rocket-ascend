            ...
            >
              <motion.div>
                <StyledButton
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Box sx={{ position: "absolute", inset: 0, background: "linear-gradient(to right, #9333ea, #a855f7)", opacity: 0, transition: "opacity 0.3s", "&:hover": { opacity: 1 } }}></Box>
                  <ButtonContent>
                    <Play style={{ marginRight: "12px" }} size={28} />
                    <span>Watch the video</span>
                  </ButtonContent>
                  <Box sx={{ position: "absolute", inset: 0, border: "1px solid rgba(255, 255, 255, 0.2)", borderRadius: "9999px" }}></Box>
                </StyledButton>
                <Typography sx={{ mt: 2, color: "gray.400", fontSize: "0.875rem" }}>
            ...
            >
              <VideoAspectRatio>
                {showYouTubeVideo ? (
                  ...
                  <VideoThumbnail 
                    onClick={toggleVideo} 
                    sx={{ backgroundImage: "url('https://img.youtube.com/vi/Wleby2uqYDE/maxresdefault.jpg')" }}
                  />
                )}
              </VideoAspectRatio>
                ...
                {!showYouTubeVideo && (
                  ...
                  >
                    <PlayButton
                      ...
                      whileTap={{ scale: 0.9 }}
                    >
                      <Play size={36} style={{ color: "white" }} />
                    </PlayButton>
                  </VideoOverlay>
                )}
              </AnimatePresence>
              ...
              <CornerElement corner="topLeft" />
              <CornerElement corner="topRight" />
              <CornerElement corner="bottomLeft" />
              <CornerElement corner="bottomRight" />
            </VideoContainer>
